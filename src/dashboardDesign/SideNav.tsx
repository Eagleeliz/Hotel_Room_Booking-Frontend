  ...
  return (
    <div className="p-4">
      ...
      <ul className="space-y-2">
        <li>
          <NavLink to="/dashboard" end className={navItemClass} onClick={onClose}>
            {({ isActive }) => (
              <>
                <LayoutDashboard
                  className={`w-6 h-6 ${isActive ? "text-red-600" : "text-rose-600"}`}
                />
                <span>Dashboard</span>
              </>
            )}
        ...
        <li>
          <NavLink to="/dashboard/orders" className={navItemClass} onClick={onClose}>
            {({ isActive }) => (
              <>
                <FaCalendarCheck
                  className={`w-6 h-6 ${isActive ? "text-red-600" : "text-rose-600"}`}
        ...
        <li>
          <NavLink to="/dashboard/payments" className={navItemClass} onClick={onClose}>
            {({ isActive }) => (
              <>
                <FaCreditCard
                  className={`w-6 h-6 ${isActive ? "text-red-600" : "text-rose-600"}`}
        ...
        <li>
          <NavLink to="/dashboard/support-tickets" className={navItemClass} onClick={onClose}>
            {({ isActive }) => (
              <>
                <TicketCheck
                  className={`w-6 h-6 ${isActive ? "text-red-600" : "text-rose-600"}`}
        ...
        <li>
          <NavLink to="/dashboard/profile" className={navItemClass} onClick={onClose}>
            {({ isActive }) => (
              <>
                <SquareUserRound
                  className={`w-6 h-6 ${isActive ? "text-red-600" : "text-rose-600"}`}
        ...
        <li>
          <NavLink to="/dashboard/logout" className={navItemClass} onClick={onClose}>
