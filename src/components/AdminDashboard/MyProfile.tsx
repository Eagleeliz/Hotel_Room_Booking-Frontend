...
const MyProfile: React.FC = () => {
  ...
  // ✅ Load user data and image only if not already set
  useEffect(() => {
    if (data) {
      setFormData((prev) => ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Update preview image to match the newly saved one
          ...
          <div className="p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end gap-4 pt-4">
                <button
                  type="button"
                  className="px-6 py-2 !bg-gray-500 text-white font-medium rounded-lg hover:bg-gray-300 transition-colors duration-200"
